        ...
        <div className="bg-gray-900/95 backdrop-blur-sm border border-blue-500/30 rounded-lg p-4 shadow-2xl">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-white">
              Value: <span className="font-bold text-blue-400">{formatPrice(value)}</span>
            </span>
          </div>
        </div>
      );
    ...
    return (
      <div className="h-[400px] flex items-center justify-center bg-gradient-to-br from-gray-900/50 to-gray-800/50 rounded-xl border border-white/10 backdrop-blur-sm">
        <div className="text-center p-8">
          ...
          <p className="text-white/80 font-semibold mb-2">No Value Projection Data</p>
          <p className="text-white/50 text-sm">Property value projections will appear here once analysis is complete</p>
        </div>
      </div>
    );
  }
      ...
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
          ...
          <Area
            ...
            dot={{ fill: "#3b82f6", strokeWidth: 3, r: 5, filter: "url(#dropShadow)" }}
            activeDot={{ 
              r: 8, 
              stroke: "#60a5fa", 
              strokeWidth: 3, 
