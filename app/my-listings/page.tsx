                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-full sm:w-48 h-32 bg-gray-200 rounded-lg overflow-hidden">
                      {listing.images && listing.images.length > 0 && listing.images[0] ? (
                        <img
                          src={listing.images[0].thumbnail_medium_url || listing.images[0].s3_url}
                          alt={listing.title}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-gray-600 mb-3">
                      ...
                      {listing.square_feet && (
                        <div>{listing.square_feet.toLocaleString()} sq ft</div>
                      )}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="text-xs text-gray-500">
                        ...
                        {listing.status === "approved" && listing.reviewed_at && (
                          <> • Approved: {new Date(listing.reviewed_at).toLocaleDateString()}</>
                        )}
                      </div>
                    ...
                    {listing.status === "rejected" && listing.rejection_reason && (
                      <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-md">
                        ...
                        <p className="text-sm text-red-700 mt-1">{listing.rejection_reason}</p>
                      </div>
                    )}
                  </div>
                </div>
