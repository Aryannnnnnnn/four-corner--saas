...
export default function ListingsPage() {
  ...
  const filteredListings = listings.filter((listing) => {
    ...
    if (filters.bedrooms !== "all" && listing.bedrooms !== Number(filters.bedrooms)) {
      return false;
    }
      ...
      <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 mt-20">
        ...
        {filteredListings.length === 0 ? (
          <Card className="p-8 md:p-12 text-center">
            ...
            <h3 className="text-base md:text-lg font-medium text-gray-900 mb-2">No properties found</h3>
              ...
              >
                ...
                <div className="relative h-48 md:h-56 bg-gray-200">
                  {listing.images && listing.images.length > 0 && listing.images[0] ? (
                    <img
                      src={listing.images[0].thumbnail_large_url || listing.images[0].thumbnail_medium_url || listing.images[0].s3_url}
                      alt={listing.title}
                      ...
                      onError={(e) => {
                        ...
                        if (target.parentElement) {
                          target.parentElement.innerHTML = '<div class="w-full h-full flex items-center justify-center text-gray-400"><svg class="w-16 h-16" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg></div>';
                        }
                      }}
                    />
                  ) : (
                ...
                <div className="p-4 md:p-5">
                  ...
                  <div className="mb-3">
                    <p className="text-2xl md:text-3xl font-bold text-blue-600">
                      ...
                      {listing.listing_type === "rent" && <span className="text-base md:text-lg font-normal">/mo</span>}
                    </p>
                  </div>
