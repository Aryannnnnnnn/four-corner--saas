...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 w-64 bg-gray-900 transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        {/* Navigation */}
        <nav className="mt-8 px-4 space-y-1 overflow-y-auto" style={{maxHeight: "calc(100vh - 12rem)"}}>
          {navigation.map((item) => {
